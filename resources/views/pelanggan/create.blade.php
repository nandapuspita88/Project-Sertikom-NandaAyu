        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputKelamin">Jenis Kelamin</label>
                        <input type="text" class="form-control @error('jenis_kelamin') is-invalid @enderror" id="exampleInputJenisKelamin" placeholder="Masukkan Jenis Kelamin" name="jenis_kelamin">
                        @error('jenis_kelamin') <span class="text-danger">{{$message}}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="exampleInputUmur">Umur</label>
                        <input type="text" class="form-control @error('umur') is-invalid @enderror" id="exampleInputUmur" placeholder="Masukkan Umur" name="umur" value="{{old('umur')}}">
